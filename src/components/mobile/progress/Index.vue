<template>
    <div class="container" id="container"><div class="progress">
        <div class="hd">
        ...
        <div class="bd spacing">
            ...
            <div class="weui-btn_area">
                <a href="javascript:;" v-bind:class="['weui-btn', 'weui-btn_primary', {'weui-btn_disabled': disabled}]" @click = "showProgress">上传</a>
            </div>
        </div>
    </div></div>
</template>
